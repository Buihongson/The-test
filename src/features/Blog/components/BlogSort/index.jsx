      ...
      <Form>
        <Form.Row className="align-items-end justify-content-end">
          <Col sm={2} className="my-1">
            ...
            <Form.Control as="select" custom name="sortBy" onChange={(e) => handleChangeSelect(e)}>
          ...
          <Col sm={2} className="my-1">
            ...
            <Form.Control as="select" custom name="order" onChange={(e) => handleChangeSelect(e)}>
